<footer class="bg-[#050505] text-white pt-24 pb-12 border-t border-white/10">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col items-center text-center mb-24">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Stop overpaying on<br>freight invoices</h2>
            <p class="text-gray-400 mb-8 max-w-xl">Join 2,000+ drayage professionals who've saved $175M+ in per diem fees. Start your free trial today.</p>
            <button class="bg-[var(--color-bluecargo-primary)] hover:bg-[var(--color-bluecargo-primary-hover)] text-white px-8 py-3 rounded-full font-medium transition-colors flex items-center gap-2">
                Start Free Trial
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16 border-t border-white/10 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">AI Invoice Auditing</a></li>
                    <li><a href="#" class="hover:text-white">Container Tracking</a></li>
                    <li><a href="#" class="hover:text-white">Terminal Data</a></li>
                    <li><a href="#" class="hover:text-white">Dispute Management</a></li>
                    <li><a href="#" class="hover:text-white">Cost Analytics</a></li>
                    <li><a href="#" class="hover:text-white">Port Coverage</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Drayage Carriers</a></li>
                    <li><a href="#" class="hover:text-white">Freight Forwarders</a></li>
                    <li><a href="#" class="hover:text-white">Shippers (BCOs)</a></li>
                    <li><a href="#" class="hover:text-white">Logistics Providers</a></li>
                    <li><a href="#" class="hover:text-white">Brokers</a></li>
                </ul>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-xs text-gray-500">
            <p>© BlueCargo, Inc. 2024 • 440 N Barranca Ave #6606, Covina, CA 91723 • 650-480-1760</p>
